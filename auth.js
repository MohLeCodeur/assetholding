/**
 * Asset Holding Authentication System
...
(function () {
    ...
    const AUTH_KEY = 'asset_auth_user';
    const AUTH_TOKEN_KEY = 'asset_auth_token';

    // Utilisateurs de démonstration (à remplacer par une vraie API)
    // En production, ceci devrait être géré côté serveur
    const DEMO_USERS = [
        { email: 'info@beta-concept.com', password: 'W529hS621pL3s4Zk279@', name: 'Client Demo', role: 'client' }
    ];
